    ...
    public static final class Builder {
        ...
        public Builder setLore(String... lore){
            ...
            for(String lores : lore){
                loreList.add(Component.text(lores));
            }
        ...
        public Builder setKey(String key) {
            NamespacedKey namespaced = CommonModule.getInstance().getInventoryType();
            itemmeta.getPersistentDataContainer().set(namespaced, PersistentDataType.STRING, key);
            return this;
        }
