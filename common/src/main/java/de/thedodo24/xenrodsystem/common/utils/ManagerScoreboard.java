...
import de.thedodo24.xenrodsystem.common.classes.Board;
import de.thedodo24.xenrodsystem.common.player.CustomScoreboardType;
import de.thedodo24.xenrodsystem.common.player.ScoreboardModule;
...
public class ManagerScoreboard {
    ...
    public ManagerScoreboard(Player player) {
        ...
        this.board = new Board("§2§lEvergreen§a§lStats");
